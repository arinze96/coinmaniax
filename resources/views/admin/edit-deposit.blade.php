                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="" method="POST" data-post-type="edit-plan"
                                                            action="{{ route('admin.deposit.view', ['edit', $deposit->id]) }}">
                                                            ...
                                                            <div class="col-sm-6 col-md-12 mb-2">
                                                                <div class="form-group">
                                                                    <label class="form-label" for="message"> Deposit
                                                                        Message</label>
                                                                    <div class="form-control-wrap">
                                                                        <input required="" type="text"
                                                                            name="message" class="form-control"
                                                                            id="message" placeholder="Enter message"
                                                                            value="{{ !empty(old('message')) ? old('message') : $deposit->message }}">
                                                                    </div>
                                                                    @error('message')
                                                            ...
                                                            <div class="col-sm-6 col-md-12 mb-2">
                                                                <div class="form-group">
                                                                    <label class="form-label" for="min">Deposit
                                                                        Amount ({{ $deposit->currency }})</label>
                                                                    <div class="form-control-wrap">
                                                                        <input required="" type="text"
                                                                            name="amount" class="form-control"
                                                                            id="amount" placeholder="Enter amount"
                                                                            value="{{ !empty(old('amount')) ? old('amount') : number_format($deposit->amount, 0, '', '') }}">
                                                                    </div>
                                                                    @error('amount')
                                                                        <span class="text-danger"
                                                            ...
                                                            <div class="col-sm-6 col-md-12 mb-2">
                                                                <div class="form-group">
                                                                    <label class="form-label" for="status">Deposit
                                                                        Status</label>
                                                                    <div class="form-control-wrap">
                                                                        <select name="status" class="form-control">
                                                                            ...
                                                                            @foreach (config('app.deposit_status') as $key => $status)
                                                                                <option
                                                                                    @if (old('status') == $key || $deposit->status == $key) selected @endif
                                                                                    value="{{ $key }}">
                                                                                    {{ $status }}</option>
                                                                            @endforeach
                                                                        </select>
