            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    <div class="col-8 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Edit NFP</h4>
                                <form class="" method="POST" data-post-type="edit-plan" action="{{ route("admin.nfp.view",["edit",$nfps->id]) }}">
                                 ...
                                 <div class="col-sm-6 col-md-12 mb-2">
                                  <div class="form-group">
                                   <label class="form-label" for="min">Deposit Amount ({{ $nfps->currency }})</label>
                                   <div class="form-control-wrap">
                                    <input required="" type="text" name="amount" class="form-control" id="amount" placeholder="Enter amount" value="{{ !empty(old("amount")) ? old("amount") : $nfps->amount  }}">
                                   </div>
                                   @error('amount')
                                 ...
                                 <div class="col-sm-6 col-md-12 mb-2">
                                  <div class="form-group">
                                   <label class="form-label" for="status">NFP funds Status</label>
                                   <div class="form-control-wrap">
                                    <select name="status"  class="form-control">
                                      <option value="" disabled selected>Select</option>
                                      @foreach(config("app.deposit_status") as $key => $status) 
                                      <option @if ((old("status") == $key) || ($nfps->status == $key))
                                                selected
                                              @endif 
                                ...
                                <div class="col-sm-4 mt-3">
                                 <div class="form-group">
                                  <div class="form-control-wrap">
                                   <button type="submit"  name="edit-plan" style="text-align:center;" class="d-block form-control btn btn-primary " >Edit NFP funds Record</button>
                                  </div>
                                 </div>
                                </div>
