        ...
        <div class="container-fluid py-4">
                                    ...
                                    <div class="col-7">
                                        <div class="numbers">
                                            <p class="text-sm mb-0 text-capitalize font-weight-bold"
                                                style="color: white">Charity Donation
                                            </p>
                                            <h5 class="font-weight-bolder mb-0">
                            ...
                            <div class="card-body p-3">
                                <div class="row">
                                    <div class="col-7">
                                        <div class="numbers">
                                            <p class="text-sm mb-0 text-capitalize font-weight-bold"
                                                style="color: white">Retirement Funds
                                            </p>
                                            <h5 class="font-weight-bolder mb-0">
            ...
            <div class="row mt-4">
                <div class="col-lg-7 mb-lg-0 mb-4">
                    <div class="card" style="background-color: #ffffff40!important;"" >
                        <div class="card-body p-3">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="d-flex flex-column h-100">
                                        ...
                                        <p class="mb-5">At Gloryinvestmentlimited we prioritize your financial goals and
                                    ...
                                    <div class="bg-gradient-primary border-radius-lg h-100">
                                        ...
                                        <div
                                            ...
                                            <img class="w-100 position-relative z-index-2 pt-4"
                                                src="{{ asset('new/assets/img/illustrations/rocket-white.png') }}"
                                                alt="rocket">
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-lg-5 mb-lg-0 mb-4">
                    <div class="card z-index-2" style="background-color: #ffffff40!important;"">
                        <div class="card-body p-3">
