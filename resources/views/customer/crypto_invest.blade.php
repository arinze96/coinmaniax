                                ...
                                <div class="card overflow-hidden">
                                  <div class="card-body pb-0">
                                    <div>
                                      ...
                                      <h3 class="mb-1 font-weight-bold">$19m</h3>
                                    </div>
                                  </div>
                                ...
                                <div class="card overflow-hidden">
                                  <div class="card-body pb-0">
                                    <div>
                                      ...
                                      <h3 class="mb-1 font-weight-bold">$12m</h3>
                                    </div>
                                  </div>
                                  <div class="chart-wrapper">
                                    <canvas
                                ...
                                <div class="card overflow-hidden">
                                  <div class="card-body pb-0">
                                    <div>
                                      ...
                                      <h3 class="mb-1 font-weight-bold">$3.5m</h3>
                                    </div>
                                  </div>
                                  <div class="chart-wrapper">
                                    <canvas
                                ...
                                <div class="card overflow-hidden">
                                  <div class="card-body pb-0">
                                    <div>
                                      ...
                                      <h3 class="mb-1 font-weight-bold">$4.7m</h3>
                                    </div>
                                  </div>
                                  <div class="chart-wrapper">
                                    <canvas
                            ...
                            <div class="text-center">
                                <div class="pri-tabs-heading pri-tabs-heading2">
                                    <ul class="nav nav-price">
                                        <li>
                                            <a class="active show" data-toggle="tab" href="#month1">CRYPTOCURRENCY INVESTMENT
                                                PLANS</a>
                                        </li>
                                    </ul>
                                </div>
                                                ...
                                                <div class="card plan-card shadow-none border">
                                                    <div class="card-block">
                                                        <div class="pt-4 pb-4">
                                                            <h1>
                                                                <i
                                                                  class="fa fa-trophy plan-icon bg-secondary"
                                                                ></i>
                                                              </h1>
                                                              <h6
                                                    ...
                                                    <div class="card-block">
                                                        <div class="pt-4 pb-4">
                                                            <h1>
                                                              ...
                                                              <h6
                                                                class="text-uppercase font-weight-semibold text-info"
                                                              >
                                                                Enterprise Pack
                                                              </h6>
                                                        </div>
