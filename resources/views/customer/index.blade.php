...
<body class="g-sidenav-show   " style="background-color: #003366">
    ...
    <main class="main-content  position-relative max-height-vh-100 h-100 ">
        ...
        <div class="container-fluid py-4">
            <h6 class="font-weight-bolder mb-0" style="color: white; margin-top: 20px; font-size: 30px">
                <span style="color: white">Balnce:</span> ${{ number_format($account->dolla_balance, 0, '.', ',') }}
            </h6>
            ...
            <div class="row">
                {{-- USD EARNED --}}
                <div class="col-xl-4 col-sm-6 mb-xl-0 mb-4" style="margin-top: 20px;">
                                    ...
                                    <div class="col-8">
                                        <div class="numbers">
                                            <p style="color: white; font-size: 10px; font-weight: bold">
                                                INVESTED AMOUNT </p>
                                            <h5 class="font-weight-bolder mb-0">
                                                {{-- ${{ $investmentsFirst == null ? '0.00' : number_format($investmentsFirst->amount, 0, '.', ',') }} --}}
                                            </h5>
                                        </div>
                                    </div>
                                    <div class="col-4 text-end">
                                ...
                                <div class="row">
                                    <div class="col-8">
                                        <div class="numbers">
                                            ...
                                            <h5 class="font-weight-bolder mb-0">
                                                ${{ $retirementFirst == null ? '0.00' : number_format($retirementFirst->amount, 0, '.', ',') }}
                                            </h5>
                                    ...
                                    <div class="col-8">
                                        <div class="numbers">
                                            <p style="color: white; font-size: 10px; font-weight: bold">
                                                CHILDREN EARNINGS</p>
                                            <h5 class="font-weight-bolder mb-0">
                                                {{-- ${{ number_format($childrenAccount[0]->amount, 0, '.', ',') }} --}}
                                                ${{ $childrenAccountFirst == null ? '0.00' : number_format($childrenAccountFirst->amount, 0, '.', ',') }}
                                            </h5>
                                    ...
                                    <div class="col-8">
                                        <div class="numbers">
                                            <p style="color: white; font-size: 10px; font-weight: bold">
                                                NFP EARNINGS</p>
                                            <h5 class="font-weight-bolder mb-0">
                                                {{-- ${{ number_format($nfp[0]->amount, 0, '.', ',') }} --}}
                                                ${{ $nfpFirst == null ? '0.00' : number_format($nfpFirst->amount, 0, '.', ',') }}
                                            </h5>
                                    ...
                                    <div class="col-8">
                                        <div class="numbers">
                                            <p style="color: white; font-size: 10px; font-weight: bold">
                                                WITHDRAWN AMOUNT</p>
                                            <h5 class="font-weight-bolder mb-0">
                                                ${{$withdrawalsFirst == null ? "0.00" : number_format($withdrawalsFirst->amount, 0, '.', ',') }}
                                            </h5>
                            ...
                            <div class="container border-radius-lg">
                                <div class="row">
                                    <div class="col-3 py-3 ps-0">
                                        ...
                                        <h4 class="font-weight-bolder">366K</h4>
                                    ...
                                    <div class="col-3 py-3 ps-0">
                                        <div class="d-flex mb-2">
                                            ...
                                            <p class="text-xs mt-1 mb-0 font-weight-bold">Cheques</p>
                                        </div>
                                        <h4 class="font-weight-bolder">12m</h4>
                                        <div class="progress w-75">
                                    ...
                                    <div class="col-3 py-3 ps-0">
                                        <div class="d-flex mb-2">
                                            ...
                                            <p class="text-xs mt-1 mb-0 font-weight-bold">profits</p>
                                        </div>
                                        <h4 class="font-weight-bolder">$435m</h4>
                                        <div class="progress w-75">
                                    ...
                                    <div class="col-3 py-3 ps-0">
                                        <div class="d-flex mb-2">
                                            ...
                                            <p class="text-xs mt-1 mb-0 font-weight-bold">Packages</p>
                                        </div>
                                        ...
                                        <tbody>
                                            @foreach ($investments as $key => $investment)
                                                <tr>
                                                    ...
                                                    <td class="align-middle text-center text-sm">
                                                        {{ ucwords($investment->percent_commission) }}%</td>
                                                    <td class="align-middle text-center text-sm">
                        ...
                        <div class="col-lg-6 mb-lg-0 mb-4">
                            <div class="copyright text-center text-sm text-muted text-lg-start">
                                ...
                                <a href="https://staretontech.com/" class="font-weight-bold"
                                    target="_blank">Glory Limited Company LTD</a>
                            </div>
                        </div>
                    </div>
                </div>
