...
<body class="home">
    ...
    <div id="page" class="full-page">
        ...
        <main id="content" class="site-main">
                ...
                <div class="container">
                    ...
                    <div class="regarding-us">
                        <div class="row justify-content-center">
                            <div class="col-lg-3 col-md-4 col-sm-6 px-lg-3">
                                <div class="qulifaction-content">
                    ...
                    <div class="single-page-section">
                        <div class="container">
                            <figure class="single-feature-img figure-round-border">
                                <img src="assets/img/image020.jpg" alt="">
                            </figure>
                            <div class="page-content">
                                <div class="section-head-info">
                                    <h6 class="section-sub-title">Our Growth and Investment Strategy</h6>
                ...
                <div class="container">
                    <div class="col-lg-8 offset-lg-2 text-center">
                        <div class="section-head-center-line mb-lg-0">
                            <h6 class="section-sub-title">What we offer</h6>
                            <h4 class="section-title">
                                We offer the best!
                            </h4>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-sm-6 feature-item">
                            <div class="feature-type type-b">
                                ...
                                <p class="feature-desc">
                                    concessional loans, supporting sectors like agriculture and retirement planning
                                </p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-sm-6 feature-item">
                        ...
                        <div class="col-lg-3 col-sm-6 feature-item">
                            <div class="feature-type type-b">
                                <figure class="servie-icon">
                                    <i aria-hidden="true" class="icon icon-worker"></i>
                                </figure>
                                <h5 class="feature-header">
                                    <a href="feature-detail.html">
                                        Crypto Investment
                                ...
                                <p class="feature-desc">
                                    Expert Strategies for Maximizing Returns in the Dynamic World of Cryptocurrency.
                                </p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-sm-6 feature-item">
                        ...
                        <div class="col-lg-3 col-sm-6 feature-item">
                            <div class="feature-type type-b">
                                <figure class="servie-icon">
                                    <i aria-hidden="true" class="icon icon-business1"></i>
                                </figure>
                                <h5 class="feature-header">
                                    <a href="feature-detail.html">
                                        Financial Advisor
                        ...
                        <div class="col-lg-3 col-sm-6 feature-item">
                            <div class="feature-type type-b">
                                <figure class="servie-icon">
                                    <i aria-hidden="true" class="icon icon-Safe-house"></i>
                                </figure>
                                <h5 class="feature-header">
                                    <a href="feature-detail.html">
                                        Real Estate
            ...
            <section class="carrer-page-section">
                <div class="container">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="vacancy-content">
                                                    ...
                                                    <p>Reliable Ally for Financial Prosperity, Our Accredited Team Guarantees Expertise, Safety, and Constant Innovation</p>
                                                    <a href="#" class="button-round-primary">GET STARTED</a>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="vacancy-content">
                                                    ...
                                                    <p>
                                                        A Reliable Brand, Providing Excellence, Integrity, and Innovative Financial Solutions to Inspire Your Trust.</p>
                                                    <a href="#" class="button-round-primary">GET STARTED</a>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="vacancy-content">
                                                    ...
                                                    <p>Expert in Evaluating and Ensuring Integrity of Financial and Physical Assets</p>
                                                    <a href="#" class="button-round-primary">GET STARTED</a>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="vacancy-content">
                                                    ...
                                                    <p>Professional Insurance Agent Skilled in Tailoring Policies for Optimal Coverage and Client Peace of Mind.</p>
                                                    <a href="#" class="button-round-primary">GET STARTED</a>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="about-service-wrap">
                    <div class="container">
                        <div class="row no-gutters align-items-end">
                            ...
                            <div class="col-lg-5">
                                <p class="mb-0">
                                    For over 25 years, our company has been a steadfast presence, navigating the ever-evolving landscape of finance. With a rich history of expertise, innovation, and client success, we continue to stand as a reliable and trusted force in the financial industry.
                                </p>
                            </div>
                        </div>
