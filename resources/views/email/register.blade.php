                        ...
                        <tbody>
                            <tr>
                                <td style="padding: 30px 30px 15px 30px;">
                                    <h2
                                        style="font-size: 18px; color: #6576ff; font-weight: 600; margin: 0;text-align: center;">
                                        {{ $data['title'] }}</h2>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td style="padding: 20px 30px 40px">
                                    <p style="margin: 0; font-size: 13px; line-height: 22px; color:#9ea8bb;">This is an
                                        ...
                                        issues, please contact us at {{ $data['appMail'] }}</p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                        ...
                        <tbody>
                            <tr>
                                <td style="text-align: center; padding:25px 20px 0;">
                                    <p style="font-size: 13px;">Copyright © {{ $data['year'] }} {{ $data['appName'] }}.
